...
const Button = ({ children, buttonType, type, disabled, customClass }) => {
    ...
    let classes = 'bg-brand-primary inline-flex justify-center items-center text-center px-2 text-white font-semibold tracking-widest py-4 w-full rounded-md transition focus:ring-2 focus:ring-brand-primary focus:ring-opacity-70 focus:outline-none ring-offset-2 hover:bg-opacity-90 active:bg-brand-tertiary active:bg-opacity-70';
    switch (buttonType) {
        case 'anchor':
